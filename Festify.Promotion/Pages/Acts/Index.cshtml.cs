...
public class IndexModel : PageModel
{
    ...
    public IndexModel(ActQueries actQueries, ActCommands actCommands, ContentQueries contentQueries,
    ...
    [BindProperty] public string ImageHash { get; set; }
    [BindProperty] public long LastModifiedTicks { get; set; }
